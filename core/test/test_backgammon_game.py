"""
Pruebas integradas para BackgammonGame: validan lógica de turnos, movimientos, reglas y estado del juego.
"""
import unittest
...
"""
pruebas integradas para BackgammonGame, cubriendo lógica completa de juego y validaciones.
"""
class TestBackgammonGameIntegrado(unittest.TestCase):
    def setUp(self):
        """
        Inicializa el entorno de prueba creando el tablero, dados, jugadores y la instancia del juego.
        También fuerza el turno y los movimientos restantes para simular una partida en curso.
        """
        self.board = Board()
        self.dice = Dice()
    ...
    def test_fichas_en_tablero(self):
        ...
        No realiza aserciones; sirve como base para pruebas de estado visual o lógica de conteo.
        """
    ...
    def test_fichas_en_bar(self):
        """
        Simula fichas en el bar y verifica que get_fichas_en_bar retorne correctamente la cantidad.
        """
        self.game.__board__.get_tablero = lambda: {
            "posiciones": [],
    ...
    def test_fichas_sacadas(self):
        """
        Simula fichas fuera del tablero y verifica que get_fichas_sacadas retorne correctamente la cantidad.
        """
        self.game.__board__.get_tablero = lambda: {
            "posiciones": [],
            "bar": {"player1": 0, "player2": 0},
    ...
    def test_estado_jugador(self):
        """
        Verifica que el estado del jugador incluya nombre, ficha y total de fichas (15).
        """
    ...
    def test_get_fichas_en_bar(self):
        """
        Establece fichas en el bar y verifica que el método del jugador las retorne correctamente.
        """
    ...
    def test_get_fichas_sacadas(self):
        """
        Establece fichas fuera del tablero y verifica que el método del jugador las retorne correctamente.
        """
    ...
    def test_get_fichas_en_tablero(self):
        """
        Verifica que el jugador tenga 15 fichas en el tablero al inicio de la partida.
        """
    ...
    def test_hay_ganador_true(self):
        """
        Simula que el jugador ha sacado 15 fichas y verifica que el juego detecte la victoria.
        """
    ...
    def test_hay_ganador_false(self):
        """
        Simula que ningún jugador ha sacado 15 fichas y verifica que no haya ganador.
        """
    ...
    def test_calcular_movimientos_totales_normal(self):
        """
        Verifica que el cálculo de movimientos con dados distintos retorne ambos valores como lista.
        """
    ...
    def test_calcular_movimientos_totales_dobles(self):
        """
        Verifica que el cálculo de movimientos con dados iguales retorne cuatro repeticiones del mismo valor.
        """
    ...
    def test_calcular_movimientos_totales_dado_invalido(self):
        """
        Verifica que se lance ValorDadoInvalidoError si algún dado está fuera del rango permitido.
        """
    ...
    def test_get_jugador_por_nombre_valido(self):
        """
        Verifica que get_jugador_por_nombre retorne correctamente el jugador solicitado.
        """
    ...
    def test_get_jugador_por_nombre_invalido(self):
        """
        Verifica que se lance TurnoJugadorInvalidoError si el nombre del jugador no existe.
        """
    ...
    def test_quien_empieza_asigna_turno(self):
        """
        Verifica que quien_empieza retorne 1 o 2 y que el turno interno se actualice correctamente.
        """
    ...
    def test_quien_empieza_asigna_turno_jugador_uno(self):
        """
        Fuerza el turno inicial para jugador uno y verifica que quien_empieza lo asigne correctamente.
        """
    ...
    def test_quien_empieza_asigna_turno_jugador_dos(self):
        """
        Fuerza el turno inicial para jugador dos y verifica que quien_empieza lo asigne correctamente.
        """
        self.game.__turno__ = 0
        turno = 0
        while turno != 2:
    ...
    def test_iniciar_partida_valido(self):
        """
        Ejecuta iniciar_partida y verifica que el turno se asigne correctamente (1 o 2).
        """
        self.game.__turno__ = 0
    ...
    def test_get_movimientos_totales_valido(self):
        """
        Verifica que get_movimientos_totales retorne correctamente los valores de los dados como lista.
        """
    ...
    def test_lanzar_dados_valido(self):
        """
        Lanza los dados y verifica que movimientos_restantes se asigne correctamente:
        4 si hay dobles, 2 si son distintos.
        """
    ...
    def test_get_jugador_actual_valido(self):
        """
        Fuerza el turno a jugador dos y verifica que get_jugador_actual retorne el jugador correcto.
        """
    ...
    def test_estado_turno_ejecucion(self):
        ...
        Verifica que el método se ejecute sin errores y muestre el estado actual del turno.
        """
        self.game.__turno__ = 1
    ...
    def test_cambiar_turno_de_2_a_1(self):
        """
        Inicializa la partida, fuerza el turno a jugador dos y ejecuta cambiar_turno.
        Verifica que el turno se actualice correctamente a jugador uno.
        """
        self.game.iniciar_partida()
        self.game.__turno__ = 2
    ...
    def test_dado_fuera_de_rango_lanza_error(self):
        """
        Verifica que calcular_movimientos_totales lance ValorDadoInvalidoError
        cuando se proporciona un dado fuera del rango permitido (0).
        """
        with self.assertRaises(ValorDadoInvalidoError):
            self.game.calcular_movimientos_totales(0, 5)
    ...
    def test_get_jugador_por_nombre_invalido(self):
        """
        Verifica que get_jugador_por_nombre lance TurnoJugadorInvalidoError
        cuando se solicita un jugador con nombre inexistente.
        """
        with self.assertRaises(TurnoJugadorInvalidoError):
    ...
    def test_hay_ganador_false(self):
        """
        Verifica que hay_ganador retorne False cuando ningún jugador ha sacado 15 fichas.
        """
        self.assertFalse(self.game.hay_ganador())
    ...
    def test_mover_ficha_agota_movimientos_y_cambia_turno(self):
        ...
        Verifica que el turno se actualice automáticamente al jugador contrario.
        """
        self.game.__turno__ = 1
    ...
    def test_get_jugador_por_nombre_valido_player2(self):
        """
        Verifica que get_jugador_por_nombre retorne correctamente el jugador dos
        y que su ficha sea 'O'.
        """
    ...
    def test_mover_ficha_regla_invalida(self):
        ...
        Verifica que el resultado sea False, sin dados usados, y que el log contenga el mensaje de error.
        """
        self.game.__turno__ = 1
        self.game.__movimientos_restantes__ = 2
