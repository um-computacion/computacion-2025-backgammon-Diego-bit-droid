...
class FichasEnBarError(ErrorTablero):
    """Se lanza cuando se intenta mover una ficha del tablero teniendo fichas en el bar."""

class BearingOffNoPermitidoError(ErrorTablero):
    """Se lanza cuando se intenta sacar fichas sin tener todas en el cuadrante final."""
